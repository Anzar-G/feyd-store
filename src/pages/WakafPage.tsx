  ...
  if (hash.startsWith('#/wakaf/permintaan/terima-kasih')) {
    return (
      <div className="min-h-screen">
        <section className="pt-28 md:pt-36 pb-12 bg-emerald-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-6">
              <a href="#" onClick={(e) => { e.preventDefault(); window.location.hash = '#'; }} className="inline-flex items-center justify-center px-5 py-3 rounded-xl font-semibold text-white bg-emerald-700 hover:bg-emerald-800">
                ← Kembali ke Beranda
              </a>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={[
                ...
                activeTab === 'wakaf' ? 'bg-emerald-50 border-b-[3px] border-b-emerald-700 text-emerald-950' : 'bg-white hover:bg-emerald-50 text-emerald-950'
              ].join(' ')}
            >
              Wakaf Sekarang
            </button>
      ...
      {activeTab === 'wakaf' ? (
        <>
          <section className="relative pt-8 md:pt-10 pb-12 bg-gradient-to-br from-emerald-50 to-teal-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="rounded-xl overflow-hidden shadow-xl border bg-white relative">
                  {!heroLoaded && <SkeletonCard lines={0} className="absolute inset-0 w-full h-full z-10" />}
                  <img
                    src="/wakaf/tinified/wakaf-cover1.jpg"
                    alt="Penyerahan mushaf ke santri"
                    className={`w-full h-auto object-cover aspect-[4/3] transition-opacity duration-300 ${heroLoaded ? 'opacity-100' : 'opacity-0'}`}
                    loading="eager"
                    width={1200}
                    height={900}
                    fetchPriority="high"
        ...
        <>
          <section className="pt-8 md:pt-10 pb-10 bg-emerald-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white rounded-2xl border p-5 shadow-sm">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select id="org-type" aria-label="Jenis Lembaga" value={orgType} onChange={(e) => setOrgType(e.target.value)} className="mt-1 w-full border rounded-lg px-3 py-2 bg-white">
                  ...
                  <div>
                    ...
                    <input id="requested-count" aria-label="Jumlah Mushaf yang Diminta" type="number" value={requestedCount} onChange={(e) => setRequestedCount(e.target.value === '' ? '' : Number(e.target.value))} className="mt-1 w-full border rounded-lg px-3 py-2" />
                  ...
                  <div>
                    ...
                    <input id="pic-name" aria-label="Nama Penanggung Jawab" value={picName} onChange={(e) => setPicName(e.target.value)} className="mt-1 w-full border rounded-lg px-3 py-2" />
                  ...
                  <div>
                    ...
                    <input id="org-wa" aria-label="Nomor WhatsApp Aktif" type="tel" inputMode="numeric" pattern="[0-9]*" autoComplete="tel" value={orgWa} onChange={(e) => setOrgWa(e.target.value)} placeholder="081234567890" className="mt-1 w-full border rounded-lg px-3 py-2" />
                  ...
                  <div>
                    ...
                    <input id="org-email" aria-label="Email" type="email" value={orgEmail} onChange={(e) => setOrgEmail(e.target.value)} className="mt-1 w-full border rounded-lg px-3 py-2" />
                  </div>
                  <div className="md:col-span-2">
                ...
                <div className="mt-4">
                  <button
                    type="button"
                    className="w-full inline-flex items-center justify-center px-4 py-3 rounded-xl font-semibold text-white bg-emerald-700 hover:bg-emerald-800"
                    onClick={() => {
